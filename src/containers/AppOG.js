...
function mapStateToProps(state){
  return{
    ...
    codeBlockTransparency:state.codeBlock.codeBlockTransparency,
    search:state.search.searchQuery,
    code:state.codeBlock.code,
    updateScene:state.codeBlock.updateScene,
    example:state.codeBlock.example,
