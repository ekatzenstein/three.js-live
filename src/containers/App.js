...
class App extends Component {
    ...
    _setCode(url_path) {
        url_path = url_path === 'three.js/examples//home.html'
            ? 'home.html'
            : url_path;
        const _this = this;
            ...
            <div className="App">
                <div style={{
                    ...
                    <iframe id="preview" height={`${100-100*(headerHeight)/window.innerHeight}%`} style={{
                        ...
                        transition: this.state.animateCode
                            ? 'all 450ms'
                            : 'all 0ms',
                ...
                <Header transparency={this.state.codeBlockTransparency} cbToggle={this._codeToggle} sbToggle={this._sidebarToggle} sb={this.state.sb} cb={this.state.cb} height={this.state.headerHeight}/>

                <ExampleDrawer files={this.state.exampleFiles} searchVal={this.state.search} search={this._searchHandler} sidebar={this.state.sb} cb={this.state.cb} left={this.state.left} hh={this.state.headerHeight} animate={this.state.animateCode}/>

                <CodeDrawer animate={this.state.animateCode} transparency={this.state.codeBlockTransparency} cbTransparency={this._cbTransparency} files={this.state.exampleFiles} searchVal={this.state.search} search={this._searchHandler} sidebar={this.state.cb} left={this.state.left} leftMin={this.state.leftMin} hh={this.state.headerHeight} top={this.state.top} pathname={this.state.example} value={this.state.code} updateCode={this._updateCode} interact={this.interact} refresh={this._refreshCode}/>
}
            </div>
        );
    }
